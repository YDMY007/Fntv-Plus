...
[data-fntv-carousel-style="3"] .fntv-s3-info{position:relative;z-index:3;color:#fff;width:100%;padding:0 1rem 0 0}
...
`;
  ...
  if (_cs === 2 || _cs === 3) {
    // 样式2/3 骨架: 高度与样式1/真实轮播一致(max-height:calc(100vh-380px);aspect-ratio:16/9), 满铺暗底, 避免加载完高度跳变
